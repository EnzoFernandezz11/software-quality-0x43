...
namespace network
{
    ...
    public:
        ...
        /**
         * @brief Response structure for PIN authentication.
         */
        struct AuthResponse
        {
            bool authenticated;
        ...
        /**
         * @brief Validates a PIN entered on the matrix keypad.
         *
         * @param pin The 4-digit PIN string.
         * @param strategy Optional backend auth strategy name. When empty the
         *        backend falls back to its default (LocalMemoryAuthStrategy).
         * @return AuthResponse Authentication and mode details.
         */
        AuthResponse validatePin(const String& pin, const String& strategy = "");
